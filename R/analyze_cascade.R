...
#' examines potential cascading effects across these layers.
#'
#' @details
...
#'   1. **Layer (Degree) Scoring:** For each network layer (degree of separation),
...
#'   }
#'
#'   2. **Cascade Balance Score:** Calculated based on the equality of layer scores.
...
#'     \item \code{layer}: Integer (1-3). The "degree" of the interaction (1 = Core, 2 = Community, 3 = Distant).
#'   }
